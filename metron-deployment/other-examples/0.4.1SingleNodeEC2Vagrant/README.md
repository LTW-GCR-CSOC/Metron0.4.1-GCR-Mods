...
1. Download the 0.4.1 build (apache-metron-0.4.2.tar.gz) from [here](https://archive.apache.org/dist/metron/0.4.2/) and decompress the file. 

2. Copy this custom [Vagrant](https://github.com/LTW-GCR-CSOC/metron0.4.1/metron-deployment/other-examples/0.4.1SingleNodeEC2Vagrant/Vagrant) file and replace the Vagrant file in this directory.
