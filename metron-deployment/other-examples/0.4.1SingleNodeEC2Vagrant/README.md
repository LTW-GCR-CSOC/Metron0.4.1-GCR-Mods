...
2. Copy this custom [Vagrantfile](https://github.com/LTW-GCR-CSOC/metron0.4.1/metron-deployment/other-examples/0.4.1SingleNodeEC2Vagrant/Vagrantfile) file and copy it to this directory (replace the existing Vagrantfile that is in the directory)
```
